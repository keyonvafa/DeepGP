...
if __name__ == '__main__':
    ...
    ax.set_title("Samples from a Standard GP Trained on Step Function", fontsize = 20)
    ax.set_xlabel(r'$x$',fontsize = 20)
    ax.set_ylabel(r'$f(x)$',fontsize = 20)
    plt.savefig('gaussian_process_picture.pdf', format='pdf', bbox_inches='tight',dpi=200)
